...
- Clean evidence surfaces: delivery checklist, delivery readiness, disabled-test inventory, API version reference, country-variant matrix, setup doctor, workflows, screenshot test state, daily digest, and manual review companion render from the same Python readers.
