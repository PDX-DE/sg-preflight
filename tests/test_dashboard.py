...
""".strip()
    ...
    def test_dashboard_source_exposes_full_qa_wizard_actions(self) -> None:
        ...
        self.assertIn('ui.checkbox("Automatic mode", value=bool(initial_payload.get("trusted_tool_mode", True)))', source)
        self.assertIn("on_payload_ready=_apply_full_qa_payload", source)
