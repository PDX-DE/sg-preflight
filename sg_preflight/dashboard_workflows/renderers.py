"""Action-result visual/technical-detail rendering, the Full QA Pass
step/draft helpers, and the workflow panel renderers (daily digest, operator
handoff, manual review, batch Full QA Pass, Full QA Pass).
"""
...
from sg_preflight.dashboard_workflows.notifications import _notify_completion_safe
...
from sg_preflight.qa_pass_report import build_qa_pass_report_summary
